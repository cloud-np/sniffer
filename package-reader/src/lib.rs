pub mod packet_reader {
    ...
    pub fn read(interface_name: String, flags: u8) {
    ...
    fn handle_ethernet_frame(interface: &NetworkInterface, packet: &EthernetPacket, flags: u8) {
        let interface_name = &interface.name[..];
        match packet.get_ethertype() {
            EtherTypes::Ipv4 => handle_ipv4_packet(interface_name, packet, flags),
            EtherTypes::Ipv6 => handle_ipv6_packet(interface_name, packet, flags),
    ...
    fn handle_transport_protocol(
        ...
        match protocol {
            IpNextHeaderProtocols::Udp => {
                handle_udp_packet(interface_name, source, destination, packet, flags)
            }
            IpNextHeaderProtocols::Tcp => {
                handle_tcp_packet(interface_name, source, destination, packet, flags)
            }
    ...
    fn handle_ipv4_packet(interface_name: &str, ethernet: &EthernetPacket, flags: u8) {
    ...
    fn handle_ipv6_packet(interface_name: &str, ethernet: &EthernetPacket, flags: u8) {
